...
<meta name="description" content="e_commerce shop project">
<meta name="viewport" content="width=device-width, initial-scale=1">
      {{-- <link rel = "icon" href = 
"https://media.geeksforgeeks.org/wp-content/cdn-uploads/gfg_200X200.png" 
        type = "image/x-icon"> --}}
<link rel="stylesheet" type="text/css" href="{{url('/website/styles/bootstrap4/bootstrap.min.css') }}">
<link href="{{url('/website/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css')}}" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="{{ url('/website/plugins/OwlCarousel2-2.2.1/owl.carousel.css') }}">
<link rel="stylesheet" type="text/css" href="{{ url('/website/plugins/OwlCarousel2-2.2.1/owl.theme.default.css') }}">
<link rel="stylesheet" type="text/css" href="{{url('/website/plugins/OwlCarousel2-2.2.1/animate.cssplugins/OwlCarousel2-2.2.1/animate.css')}}">
<link rel="stylesheet" type="text/css" href="{{ url('/website/plugins/slick-1.8.0/slick.css') }}">
<link rel="stylesheet" type="text/css" href="{{ url('/website/styles/main_styles.css') }}">
<link rel="stylesheet" type="text/css" href="{{ url('/website/styles/responsive.css') }}">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="/website/images/phone.png" alt=""></div>+38 068 005 3570</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="/website/images/mail.png" alt=""></div><a href="https://colorlib.com/cdn-cgi/l/email-protection#234542505750424f465063444e424a4f0d404c4e"><span class="__cf_email__" data-cfemail="34525547404755585147745359555d581a575b59">[email&#160;protected]</span></a></div>
						<div class="top_bar_content ml-auto">
							...
							<div class="top_bar_user">
								<div class="user_icon"><img src="/wesite/images/user.svg" alt=""></div>
							...
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form action="#" class="header_search_form clearfix">
										...
										<button type="submit" class="header_search_button trans_300" value="Submit"><img src="/website/images/search.png" alt=""></button>
									</form>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right">
						<div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
							<div class="wishlist d-flex flex-row align-items-center justify-content-end">
								<div class="wishlist_icon"><img src="/website/images/heart.png" alt=""></div>
...
<script src="{{ url('/website/styles/bootstrap4/popper.js') }}"></script>
<script src="{{ url('/website/styles/bootstrap4/bootstrap.min.js') }}"></script>
<script src="{{ url('/website/plugins/greensock/TweenMax.min.js') }}"></script>
<script src="{{ url('/website/plugins/greensock/TimelineMax.min.js') }}"></script>
<script src="{{ url('/website/plugins/scrollmagic/ScrollMagic.min.js') }}"></script>
<script src="{{ url('/website/plugins/greensock/animation.gsap.min.js') }}"></script>
<script src="{{ url('/website/plugins/greensock/ScrollToPlugin.min.js') }}"></script>
<script src="{{ url('/website/plugins/OwlCarousel2-2.2.1/owl.carousel.js') }}"></script>
<script src="{{ url('/website/plugins/slick-1.8.0/slick.js') }}"></script>
<script src="{{ url('/website/plugins/easing/easing.js') }}"></script>
